...
public class ObjectFactory {
    ...
    private final static QName _Order_QNAME = new QName("urn:com.prokarma.app.middleware:enterprise-event-bus:1.0", "notification");
    ...
    public JAXBElement<Notification> createNotification(Notification value) {
        return new JAXBElement<Notification>(_Order_QNAME, Notification.class, null, value);
    }
